  ...
  return (
    <div className='about'>
      ...
      <div className='about-right'>
        ...
        <p>Enbark on a tranformative educational journey with our
           ...
           education.</p>
        <p>With a focus on innovations, hands-on learning, and personalized
            mentorship, our programs prepare aspiring educators to make a 
            meaningful impact in classrooms, aspiring, schools, and communites.</p>
        <p>Whether you aspire to become a teacher administrator, 
            ...
            full potential in shipping the future of education</p>       
      </div>
    </div>
  )
}
